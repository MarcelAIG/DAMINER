export const translations = {
  ua: {
    ...
    request: {
      ...
      empty: "Ваш запит порожній",
      success: "Запит успішно надіслано!"
    },
    contactPage: {
      heading: "Контакти",
      subheading: "Зв'яжіться з нами для обговорення співпраці, замовлення обладнання або отримання консультації.",
      ...
      formName: "Ваше ім'я",
      formEmail: "Ваш Email",
      formMessage: "Текст повідомлення",
  ...
  en: {
    ...
    request: {
      ...
      empty: "Your request is empty",
      success: "Request sent successfully!"
    },
    contactPage: {
      heading: "Contact Us",
      subheading: "Get in touch with us to discuss cooperation, order equipment, or receive a consultation.",
